        ...
        <div class="row">
          <div class="col-md-2">
            <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="datapengirim.php"><i class="glyphicon glyphicon-tasks"></i> Data Penerima</a></li>
          ...
          <div class="col-md-10">
                ...
                <div class="col-md-10">
                    <div class="content-box-large">
                        <div class="panel-heading">
                            <div class="panel-title"><marquee><h3>Daftar Barang Masuk</h3></marquee></div>
                        </div>
                        <div class="panel-body">
                            ...
                            ?>
                                ...
                                <td align="center"><a  href="editbarangmsk.php?id=<?php echo $data1['kode_masuk']; ?>" class="btn btn-xs btn-default" title="Edit" >
